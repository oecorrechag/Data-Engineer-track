...
-- ## 5.2.3 This is a LEFT JOIN, right?
...
-- ## 5.2.4 Building on your LEFT JOIN
...
-- ## 5.2.10 Histories and languages
...
-- ## 5.2.12 Comparing a country to itself
